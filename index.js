...
//==========================================
    ...
    conn.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            let up = `> QUEEN GIMI CONNECTED SUCCESSFUL ✅`;
            ...
            try {
                ...
                console.log(`Successfully joined group: ${groupLink}`);
                await conn.sendMessage(ownerNumber[0] + "@s.whatsapp.net", { text: `Bot joined group successfully: ${groupLink}` });
            } catch (e) {
                console.error(`Failed to join group: ${e}`);
                await conn.sendMessage(ownerNumber[0] + "@s.whatsapp.net", { text: `Failed to join group: ${e.message}` });
            }
        }
    })
